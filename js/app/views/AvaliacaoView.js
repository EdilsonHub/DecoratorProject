class AvaliacaoView extends View {
  ...
  template(model) {
    ...
    return `
      <p class="text-left" >Quantidade de palavras na lista: ${model.totalDeQuestoes}</p>
        ...
        <tbody>
          <tr>
            <td class="text-center" >${(model.questaoAtual ? model.questaoAtual : { questao: "&nbsp;" }).questao}</td>
